 **Before we can learn about sensitive data/PII and do some demonstrations in the terminal here, it is necessary for us to set up the WordPress and mySQL here first.**
